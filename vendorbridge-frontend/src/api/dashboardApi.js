...
export const getSummary = async () => {
  try {
    ...
    console.warn('[dashboardApi] getSummary failed, using mock data:', err.message);
    return {
      totalVendors: 1284,
      activeRFQs: 42,
      pendingApprovals: 15,
...
export const getAnalytics = async () => {
  try {
    ...
    console.warn('[dashboardApi] getAnalytics failed, using mock data:', err.message);
    return {
      monthlyProcurement: [
...
export const getRecentRFQs = async () => {
  try {
    ...
    console.warn('[dashboardApi] getRecentRFQs failed, using mock data:', err.message);
    return [
...
export const getRecentPurchaseOrders = async () => {
  try {
    ...
    console.warn('[dashboardApi] getRecentPurchaseOrders failed, using mock data:', err.message);
    return [
...
export const getRecentInvoices = async () => {
  try {
    ...
    console.warn('[dashboardApi] getRecentInvoices failed, using mock data:', err.message);
    return [
